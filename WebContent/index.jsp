<%-- tion Booking demo - � 2001,2015 IBM Corporation. --%>
<%@page errorPage="error.jsp"%>
<%
	String _pageTitle = "London online flight bookings";
	String city = "";
	String from = "";
	String to = "";
	boolean home = true;
...
<!-- INITIAL GREETINGS AND TRIP BOX -->
		<TD>
			...
			<h1 style="text-indent: 20px; margin-top: -60px;">Welcome to the Thomas's Holiday Booking Website - the best way to plan your holiday. </h1>
