...
public class CancellationBindingStub extends Stub implements Cancellation {
	...
	public CancellationBindingStub() throws AxisFault {
		this((Service) null);
	}

	public CancellationBindingStub(URL endpointURL, Service service) throws AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public CancellationBindingStub(Service service) throws AxisFault {
		...
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
		qName = new QName("http://reservations.vbooking.com/schemas/CancelBookingRequest", "CancelBookingRequestType");
		this.cachedSerQNames.add(qName);
		cls = CancelBookingRequestType.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
		...
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
		qName = new QName("http://types.reservations.vbooking.com/schemas/Gender", "Gender");
		this.cachedSerQNames.add(qName);
		cls = Gender.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(enumsf);
		this.cachedDeserFactories.add(enumdf);
		qName = new QName("http://types.reservations.vbooking.com/schemas/Reservation", "Reservation");
		this.cachedSerQNames.add(qName);
		cls = Reservation.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
	}
	...
	public CancelBookingResponse cancelBooking(CancelBookingRequestType request)
		...
		if (super.cachedEndpoint == null) {
			...
			_call.setSOAPActionURI("http://types.reservations.vbooking.com/wsdl/Reservation/CancelBooking");
			_call.setEncodingStyle((String) null);
			_call.setProperty("sendXsiTypes", Boolean.FALSE);
			_call.setProperty("sendMultiRefs", Boolean.FALSE);
			_call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
			_call.setOperationName(new QName("", "CancelBooking"));
			...
			try {
				...
				if (_resp instanceof RemoteException) {
					...
					try {
						return (CancelBookingResponse) _resp;
					} catch (Exception var5) {
						return (CancelBookingResponse) JavaUtils.convert(_resp, CancelBookingResponse.class);
					}
				}
